...
interface MoviesApi {
    @GET("movie/top_rated?api_key=c37d3b40004717511adb2c1fbb15eda4&language=en-US&p%20age=1")
    suspend fun getTopMovies(): MoviesDTO

    @GET("3/movie/122?api_key=c37d3b40004717511adb2c1fbb15eda4&language=en-US")
